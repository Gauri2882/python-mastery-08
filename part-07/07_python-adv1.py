...
def add_expense():
    category = input("Enter expense category (eg, Food, Travel,...): ").capitalize()
...
def check_saving_goals(remaining, goal):
    if remaining >= goal:
        print(f"Congratulations! You have met your saving goal with ${remaining - goal} extra.")
    else:
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            check_saving_goals(remaining, goal)
        elif choice == "5":
            plot_expenses()
        elif choice == "6":
            print("Goodbye!")
