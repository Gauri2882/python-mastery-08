...
# use 'TestDocument' path for testing this code and then you can try your own 
...
def get_folder_for_file(file_name):
    ...
    for folder, extension in file_extensions.items():
        if any(file_name.endswith(ext) for ext in extension):
            return folder       
    return "Others"
